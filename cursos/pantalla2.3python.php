  ...
  <body>
    ...
    <section class="contenido" id="cabecera">
      <div class="pagina" >
		...
		<h3 class="descripcionCurso">2.3: PALABRAS RESERVADAS EN PYTHON</h3>
		
	   
		<li>Las palabras reservadas, como su nombre lo indican, son palabras 
				las cuales el lenguaje de programación ya ha reservado para realizar ciertas tareas.
				Nosotros no podemos declarar una variable con el mismo nombre que una palabra reservada

                  </li>
              
		<center> <iframe width="560" height="315" src="https://www.youtube.com/embed/6yBL1mcd7iY" 
      ...
      autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				...
				<li><button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla2.2python.html';">Anterior </button></li>
				...
				<li><button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla2.4python.html';">Siguiente</button></li>
