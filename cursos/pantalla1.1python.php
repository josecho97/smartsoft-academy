  ...
  <body>
    ...
    <section class="contenido" id="cabecera">
      <div class="pagina" >
		...
		<h3 class="descripcionCurso">1.1: INTRODUCCIÓN  Y INSTALACIÓN </h3>
		
	   
		<li>
				
				
				Python es un lenguaje de programación de alto nivel que 
				 se utiliza para desarrollar aplicaciones de todo tipo. A 
				 diferencia de otros lenguajes como Java o .NET, se trata 
				 de un lenguaje interpretado, es decir, que no es necesario 
				 compilarlo para ejecutar las aplicaciones escritas en Python, 
				 sino que se ejecutan directamente por el ordenador utilizando 
				 un programa denominado interpretador, por lo que no es 
				 necesario “traducirlo” a lenguaje máquina. También en esta parte veremos 
				 como es la instalacion de Python, 
				 y como vereficaremos si esta instalado, tambien descargaremos 
				 PyCharm, hay varias maneras de descargarlo pero en este 
				 subtitulo veremos una manera en especial de descarga </li>
              
		<center><iframe width="560" height="315" src="https://www.youtube.com/embed/DAdRO6ByBoU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			
				<div class="botones1">
				<li><button type="button" class="btn btn-primary boton" 
					<button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla1.2python.php';">Siguiente</button>
