  ...
  <body>
    ...
    <section class="contenido">
      <div class="pagina">
		...
		<h3 class="descripcionCurso">3.2: METADATOS Y OTRAS ETIQUETAS</h3>
		
	   
		<li>
			Los metadatos son datos que describen datos, y HTML tiene una forma 
			«oficial» de introducir metadatos en un documento - el elemento <strong>&lt;meta&gt;</strong>. 
			Por supuesto, el resto de los elementos de los que hablaremos en este 
			video también se podrían considerar metadatos. Hay muchos tipos 
			diferentes de elementos <strong>&lt;meta&gt;</strong> se pueden incluir en el <strong>&lt;head&gt;</strong> de tu 
			página, pero no vamos a intentar explicarlos todos en esta etapa porque 
			resultaría demasiado confuso. En lugar de ello vamos a explicar algunas 
			cuestiones con las que seguramente te vas a encontrar, solo para que te 
			hagas una idea.
		</li>
		  
	<center> <iframe width="560" height="315" src="https://www.youtube.com/embed/eCV_-IHs5xQ" title="YouTube video player" frameborder="0" allow="accelerometer; 
		autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

	<div class="botones1">
			<li><button type="button" class="btn btn-primary boton" 
					<button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla8.php';">Anterior</button>
	 </div>
