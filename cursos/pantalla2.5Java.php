  ...
  <body>
    ...
    <section class="contenido" id="cabecera">
      <div class="pagina" >
		...
		<h3 class="descripcionCurso">2.5: LEER DATOS DESDE TECLADO</h3>
		
	   
		<li>Para recoger datos por teclado usamos System.console().readLine(). Al llegar a esta sentencia, el programa se detiene y espera que el usuario introduzca información mediante el teclado. La introducción de datos termina con la pulsación de la tecla INTRO. Una vez que el usuario presiona INTRO, todo lo que se ha tecleado se almacena en una variable.</li>
			<b><li>Ejemplo:</li></b>
			<center><img src="../images/ejemplo2.png" width="50%" height="50%px" align="center"></center>
				<br>

					        	<center>
					        		<video controls width="500" height="315">        			
					        				<source src="../videos/videoJava7.mp4" type="video/mp4">  
					        		</video>	
					        	</center>        		
		 
				<div class="botones">
				<li><button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla2.4Java.html';">Anterior </button></li>
				...
				<li><button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla3.1Java.html';">Siguiente</button></li>
				 </div>
