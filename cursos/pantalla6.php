<?php 
	...
	$sql = "INSERT INTO html VALUES('$ID','6','$USU')";
  ...
  <body>
    ...
    <section class="contenido">
      <div class="pagina">
		...
		<h3 class="descripcionCurso">2.5: TABLAS</h3>
		
	   
		<li>
			Una tabla HTML <strong>(&lt;table&gt;)</strong> es un conjunto de celdas <strong>(&lt;td&gt; o &lt;th&gt;)</strong>
			organizadas en filas <strong>(&lt;tr&gt;)</strong> que a su vez se organizan en grupos de filas 
			<strong>(&lt;thead&gt;, &lt;tbody&gt; o &lt;tfoot&gt;)</strong>. Además, la tabla puede tener una leyenda 
			<strong>(&lt;caption&gt;)</strong> y hacer referencia a las columnas <strong>(&lt;col&gt; y &lt;colspan&gt;).</strong>
			<br><br>
			A su vez, tanto los cuerpos de tabla como la cabecera y el pie de tabla 
			están formados por varias filas <strong>(&lt;tr&gt;)</strong> formadas por varias celdas 
			<strong>(&lt;td&gt; o &lt;th&gt;)</strong>. Todas las filas tienen el mismo número de celdas 
			(aunque también se pueden unir celdas horizontal y verticalmente).
		</li>
		  
		<center> <iframe width="560" height="315" src="https://www.youtube.com/embed/LmSUS6MuSzk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>	

	<div class="botones">
			<button type="button" class="btn btn-primary boton" 
					<button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla5.php';">Anterior</button>

					<li><button type="button" class="btn btn-primary boton" 
						<button type="button" class="btn btn-primary boton" 
						onclick="location.href='pantalla7.php';">Siguiente</button>
	 </div>
