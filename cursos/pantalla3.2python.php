  ...
  <body>
    ...
    <section class="contenido" id="cabecera">
      <div class="pagina" >
		...
		<h3 class="descripcionCurso">3.2: ENTRADA DE DATOS DESDE TECLADO</h3>
		
	   
		<li>La entrada de datos en Python es, como es usual en Python, 
                bastante simple por medio de la función input(). En este modulo verémos
                 entonces cómo usar la función input() de Python , para leer leer datos por teclado
                  y asignar ese valor recibido a una variable. Adicionalmente, 
                hay algunas consideraciones a tener en cuenta al momento de usar input() para leer valores por teclado en Python

                  </li>
              
		<center> <iframe width="560" height="315" src="https://www.youtube.com/embed/vlka4aIRqUc" 
            ...
            autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				...
				<li><button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla3.1python.html';">Anterior </button></li>
				...
				<li><button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla4.1python.html';">Siguiente</button></li>
