<?php 
	...
	$sql = "INSERT INTO html VALUES('$ID','10','$USU')";
  ...
  <body>
    ...
    <section class="contenido" id="cabecera">
      <div class="pagina" >
		...
		<h3 class="descripcionCurso">4.2: CREAR EL PROYECTO</h3>
		
	   
		<li>Después de habernos familiarizado con las estructura del lenguaje Java (Lenguaje Orientado a Objetos), es decir, estamos hablando de una Programación Orientada a Objetos. Para tener una idea de la estructura básica de un proyecto java, se mostrará un ejemplo "Adivina el número" con lo cual se finalizará el Curso Java Para Principiantes, esperando haber satisfecho sus espectativas e informales que estamos trabajando en próximas entregas.</li>
				...
				<li><button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla4.1Java.html';">Anterior </button></li>
