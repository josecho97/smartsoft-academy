  ...
  <body>
    ...
    <section class="contenido" id="cabecera">
      <div class="pagina" >
		...
		<h3 class="descripcionCurso">4.1: ¿Qué vamos a programar?</h3>
		
	   
		<li>Inicialmente los programas se ejecutan por consola, es decir, no existe una interfaz gráfica que habiltualmente están acostumbrados a ver en los programas convencionales.</li>
			<li>La finalidad de este curso no es realizar interfaces gráficas profesionales, ya que lo primero que se tiene entender es las herramientas tecnológicas a utilizar y la lógica con el que se modela y resuelve problemas de la vida real.</li>
              

					        	<center>
					        		<video controls width="500" height="315">        			
					        					<source src="../videos/videoJava10.mp4" type="video/mp4">  
					        		</video>	
					        	</center>        		
		 
				<div class="botones">
				<li><button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla3.2Java.html';">Anterior </button></li>
				...
				<li><button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla4.2Java.html';">Siguiente</button></li>
				 </div>
