  ...
  <body>
    ...
    <section class="contenido" id="cabecera">
      <div class="pagina" >
		...
		<h3 class="descripcionCurso">1.2: EJECUCIÓN Y COMPILACIÓN  DE UN PROGRAMA</h3>
		
	   
		<li>En esta parte veremos la definición de un programa, también veremos el 
				
			concepto de compilador, y se verá de manera practica la diferencia entre el intérprete y compilador. </li>
              
		<center> <iframe width="560" height="315" src="https://www.youtube.com/embed/UzHFkEdnRuc" 
			title="YouTube video player" frameborder="0" allow="accelerometer; 
			autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			
				<div class="botones">
				<li><button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla1.1python.html';">Anterior </button></li>
				...
				<li><button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla2.1python.html';">Siguiente</button></li>
