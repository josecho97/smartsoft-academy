  ...
  <body>
    ...
    <section class="contenido" id="cabecera">
      <div class="pagina" >
		...
		<h3 class="descripcionCurso">2.4: OPERADORES ARITMÉTICOS</h3>
		
	   
		<li>Los operadores son símbolos reservados por el propio lenguaje que se utilizan para llevar a cabo operaciones sobre uno, dos o más elementos llamados operandos. 
                Los operandos pueden ser variables, literales, el valor devuelto por una expresión o el valor devuelto por una función.

                  </li>
              
		<center> <iframe width="560" height="315" src="https://www.youtube.com/embed/6sOEpHItJHs"
            ...
            encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				...
				<li><button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla2.3python.html';">Anterior </button></li>
				...
				<li><button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla2.5python.html';">Siguiente</button></li>
