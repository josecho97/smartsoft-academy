  ...
  <body>
    ...
    <section class="contenido" id="cabecera">
      <div class="pagina" >
		...
		<h3 class="descripcionCurso">2.2: INSTALAR INTELLIJ IDEA</h3>
		
	   
		<li>En esta sección se verá como instalar un IDE (Integrated Development Environment), en el cual se comenzará a escribir el código requerido para ejecutar una instrucción desde lo más básico. Para continuar el curso se instalará el IDE "IntelliJ IDEA", el cual nos ayudará a dar el paso inicial para todo programar el saludo "Hola Mundo".</li>
      <li>Paso 1: Ve a la página de IntelliJ IDEA en Academic Software y haz clic en el botón verde 'Descargar IntelliJ IDEA CE' para descargar el archivo de instalación. Paso 2: Abre el archivo de instalación .exe de tu carpeta de descargas y haz clic en Next para iniciar la instalación.</li>        
              
		<div>
					        	<center>
					        		<video controls width="500" height="315">        			
					        				<source src="../videos/videoJava4.mp4" type="video/mp4">  
					        		</video>	
					        	</center>        		
		 </div>	
				<div class="botones">
				<li><button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla2.1Java.html';">Anterior </button></li>

					<li><button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla2.3Java.html';">Siguiente</button></li>
				 </div>
