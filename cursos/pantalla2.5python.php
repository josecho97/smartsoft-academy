  ...
  <body>
    ...
    <section class="contenido" id="cabecera">
      <div class="pagina" >
		...
		<h3 class="descripcionCurso">2.5: COMENTARIOS EN PYTHON</h3>
		
	   
		<li>Los comentarios en Python, al igual que sucede en otros lenguajes de programación, 
                sirven para explicar a las personas que puedan leer el programa en el futuro, qué es lo 
                que hace el programa, así como explicar algunas partes del código. Estos comentarios son 
                ignorados por las computadoras cuando ejecutan el código. No se tú, pero yo con el paso del 
                tiempo cada vez me olvido más de las cosas. Es algo así como dejar post-its dentro del programa.
                 Escribir comentarios en python, 
                aunque requiere un esfuerzo, es una buena práctica y compensará con creces ese esfuerzo en el futuro.
                  </li>
              
		<center> <iframe width="560" height="315" src="https://www.youtube.com/embed/xptKv7yhfSA" 
            ...
            autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				...
				<li><button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla2.4python.html';">Anterior </button></li>
				...
				<li><button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla3.1python.html';">Siguiente</button></li>
