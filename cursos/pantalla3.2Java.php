  ...
  <body>
    ...
    <section class="contenido" id="cabecera">
      <div class="pagina" >
		...
		<h3 class="descripcionCurso">3.2: SENTENCIAS CONDICIONALES</h3>
		
	   
		<li>Las sentencias condicionales son sentencias que nos permiten tomar una decisión para poder ejecutar un bloque de sentencias u otro.</li>
			<li>Se evalua la sentencia que generalmente se encuentra entre paréntesis, lo cual según su resultado TRUE o FALSE ingresará a ejecutar las setencias que el programador asi lo requiera</li>
			<ol>
				<b><li>En el lenguaje java se presentan las siguientes: </li></b>
				<li>If</li>
				<li>Else</li>
				<li>If Else</li>
				<li>Switch</li>
					        	...
					        	<center>
					        		<video controls width="500" height="315">        			
					        				<source src="../videos/videoJava9.mp4" type="video/mp4">  
					        		</video>	
					        	</center>        		
		 
				<div class="botones">
				<li><button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla3.1Java.html';">Anterior </button></li>

				<li><button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla4.1Java.html';">Siguiente</button></li>
				 </div>
