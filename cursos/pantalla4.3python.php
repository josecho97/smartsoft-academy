<?php 
	...
	$sql = "INSERT INTO html VALUES('$ID','11','$USU')";
  ...
  <body>
    ...
    <section class="contenido" id="cabecera">
      <div class="pagina" >
		...
		<h3 class="descripcionCurso">4.3: SENTENCIAS CONDICIONALES MÚLTIPLES (elif)</h3>
		
	   
		<li>La estructura de control IF...elif...elif... permite la ejecución de múltiples condiciones de forma jerárquica, 
                es decir, si no se cumple la primera condición se evalúa la siguiente condición y así sucesivamente.

                  </li>
              
		<center> <iframe width="560" height="315" src="https://www.youtube.com/embed/6mBL2p1O3AY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; 
            clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                ...
                onclick="location.href='pantalla4.2python.html';">Anterior </button></li>
            ...
            <li><button type="button" class="btn btn-primary boton" 
                onclick="location.href='pantalla4.4python.html';">Siguiente</button></li>
