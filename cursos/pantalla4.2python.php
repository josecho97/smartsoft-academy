  ...
  <body>
    ...
    <section class="contenido" id="cabecera">
      <div class="pagina" >
		...
		<h3 class="descripcionCurso">4.2: SENTENCIAS CONDICIONALES COMPUESTAS</h3>
		
	   
		<li>La estructura de control if ... else ... permite que un programa ejecute unas instrucciones 
                cuando se cumple una condición y otras 
                instrucciones cuando no se cumple esa condición. En inglés "if" significa "si" (condición)
                 y "else" significa "si no"

                 
                  </li>
              
		<center> <iframe width="560" height="315" src="https://www.youtube.com/embed/43NYFfUM5uU" 
            ...
            clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				...
				<li><button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla4.1python.html';">Anterior </button></li>
				...
				<li><button type="button" class="btn btn-primary boton" 
					onclick="location.href='pantalla4.3python.html';">Siguiente</button></li>
