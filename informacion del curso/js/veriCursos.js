   ...
   $.ajax(
   {
	...
	data:{
		...
		if(res === "proceso"){
				...
				<div class="texto">
				  <h3>Html</h3>
				  <button type="button" class="botoncito" onclick="location.href='cursos/moduloHtml.html';">Ir al Curso</button>
				</div>
			</div>
				`
				contProceso == 2;
   ...
   $.ajax(
   {
	...
	data:{
		...
		if(res === "proceso"){
				...
				<div class="texto">
				  <h3>Java</h3>
				  <button type="button" class="botoncito" onclick="location.href='cursos/moduloJava.html';">Ir al Curso</button>
				</div>
				</div>
				`
				contProceso == 3;
   ...
   $.ajax(
   {
	...
	data:{
		...
		if(res === "proceso"){
				...
				<div class="texto">
				  <h3>Python</h3>
				  <button type="button" class="botoncito" onclick="location.href='cursos/moduloPython.html';">Ir al Curso</button>
				</div>
			</div>
				`
				contProceso = 4;
